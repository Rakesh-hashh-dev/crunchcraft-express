  ...
  <div className="flex flex-col">
    ...
    <section className="bg-primary text-primary-foreground py-16 md:py-24 text-center">
      <div className="container max-w-2xl">
        ...
        <p className="font-body text-lg opacity-80">
          Your monthly supply of bold millet puffs — delivered to your door, at a price that makes your wallet crunch too.
        </p>
      </div>
    </section>
        ...
        {plans.map((p) => (
          <div
            ...
            className={`rounded-xl border p-6 flex flex-col ${
              p.popular ? "border-secondary bg-secondary/5 ring-2 ring-secondary" : "bg-card"
            }`}
          >
    ...
    <section className="container py-16 md:py-24 text-center max-w-xl">
      ...
      <p className="font-body text-muted-foreground mb-6">
        Every ₹1 spent = 1 CrunchCoin. Collect 500 coins for a free 200g pouch. Refer friends for bonus coins!
      </p>
